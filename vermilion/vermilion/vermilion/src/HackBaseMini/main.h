...
// Target game build selection.
// CS 1.6 uses protocol 47, CS 1.1/1.5 use protocol 46.
#define CS_VERSION_11 11
#define CS_VERSION_16 16
// Default to CS 1.1 as requested; switch to CS_VERSION_16 if you need the old behaviour again.
#ifndef CS_TARGET_VERSION
#define CS_TARGET_VERSION CS_VERSION_11
#endif
inline bool IsTargetCS11() { return CS_TARGET_VERSION == CS_VERSION_11; }
